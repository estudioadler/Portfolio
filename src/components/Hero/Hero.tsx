...
export const Hero = () => {
  return (
    <>
      <section className="flex flex-col gap-6 py-8 md:py-20">
        ...
        <div className="flex flex-col gap-6">
          <p className="max-w-sm text-neutral-500">Engenheiro de Software 3/7, apaixonado pela interseção de Front-end, UI Design, SEO e Acessibilidade.</p>
